...
namespace WindowsFormsApplication17
{
    ...
    public partial class Form1 : Form
    {
        ...
        void whois_win()
        {
            ...
            if (button1.Enabled == false && button2.Enabled == false && button3.Enabled == false && button4.Enabled == false && button5.Enabled == false && button6.Enabled == false && button7.Enabled == false && button8.Enabled == false && button9.Enabled == false && dreow==0)
            {
                if (MessageBox.Show("The Game Dreaw.Do You Want Start New Game ? ", "Notic", MessageBoxButtons.OKCancel, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) == DialogResult.OK)
                {
                    ...
                    button1.BackColor = Color.DarkSlateGray; button2.BackColor = Color.DarkSlateGray; button3.BackColor = Color.DarkSlateGray;
                    button4.BackColor = Color.DarkSlateGray; button5.BackColor = Color.DarkSlateGray; button6.BackColor = Color.DarkSlateGray;
                    button7.BackColor = Color.DarkSlateGray; button8.BackColor = Color.DarkSlateGray; button9.BackColor = Color.DarkSlateGray;
                    fristmove = false;
                    secondchek = false;
                    onechose = 0;
        ...
        {
            DialogResult ex = MessageBox.Show("Do you want Close Game ?", " Note ", MessageBoxButtons.OKCancel);
            if (ex == DialogResult.Cancel)
            { e.Cancel = true; }
            else
